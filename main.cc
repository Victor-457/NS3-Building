...
int main (int argc, char *argv[])
{
  ...
  if(defaultDevices == true){
    ...
    SetPosition(stas.Get(1), Vector(5.5, 5.5, 1.0));
    SetPosition(stas.Get(2), Vector(0.5, 5.5, 1.0));
    SetPosition(stas.Get(3), Vector(5.5, 0.5, 1.0));
    
    //Room1
    SetPosition(stas.Get(4), Vector(2.0, 2.0, 1.0));

    //Room 2
    SetPosition(stas.Get(5), Vector(0.5, 3.5, 1.0));
    SetPosition(stas.Get(6), Vector(1.5, 4.5, 1.0));
    SetPosition(stas.Get(7), Vector(2.5, 4.0, 1.0));

    //Room 3
    SetPosition(stas.Get(8), Vector(2.5, 5.5, 1.0));
    SetPosition(stas.Get(9), Vector(4.0, 5.0, 1.0));
    SetPosition(stas.Get(10), Vector(5.0, 3.5, 1.0));
